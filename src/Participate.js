                            ...
                            <Grid.Column className="right-section" width={10}>
                                <Slider {...settings}>
                                    ...
                                    <div>
                                        ...
                                        <p>If you hold KSM on a crypto exchange, it may provide functionality to participate in Kusama crowdloans from your user account. </p>
                                        <div className="click">Click on one of the exchanges below for more details:</div>
                                        <div className="image-holder">
                                    ...
                                    <div>
                                        ...
                                        <ol>
                                            <li>Navigate to: <a href="#">polkadot.js.org/apps/</a>.</li>
